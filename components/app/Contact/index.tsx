        ...
        >
            <Layout className="bg-transparent h-[calc(100dvh-70px)] lg:h-[calc(100dvh-108px)] overflow-y-clip lg:mt-[38px] px-3 md:px-12 xl:px-40 2xl:px-48 max-w-[1920px] mx-auto">
                <Row className="h-full">
                    ...
                    <Col xs={24} lg={12} className="h-1/2 lg:h-full flex justify-center items-center">
                        <div className="h-full w-full bg-[#fef2f2] rounded-xl flex justify-center items-center px-[96px]">
